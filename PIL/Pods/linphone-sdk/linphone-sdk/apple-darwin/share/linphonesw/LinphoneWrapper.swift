...
public class Core : LinphoneObject
{
	...
	/// when ProviderDelegate of the callkit notifies that the audio session is
	...
	/// Special function to warm up dtmf feeback stream. linphone_core_stop_dtmf_stream
	...
	/// Special function to stop dtmf feed back function. Must be called before
	/// entering BG mode 
