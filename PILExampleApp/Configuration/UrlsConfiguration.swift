...
@objc class UrlsConfiguration: NSObject {
    ...
    fileprivate var plistUrl: URL = Bundle.main.url(forResource: "Config", withExtension: "plist")! //For staging use forResource: "StangingConfig" 
    ...
    @objc func partnerUrl() -> String {
        guard urlsConfig != nil else {
            print("Can't get partner url because the config is missing")
            return ""
        }
